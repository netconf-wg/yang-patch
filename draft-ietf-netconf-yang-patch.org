...
which includes the media type for YANG Patch. Example:

  Accept-Patch: application/yang.patch, application/yang.data

For NETCONF, a YANG "rpc" statement needs to be defined.
...
- Removed open issue 'RESTCONF coupling' because thre is no
